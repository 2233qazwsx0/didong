...
EzLauncher.TextLabel.Text = "脚本状态"
...
EzLauncher.StatusName.Text = "主脚本状态"
...
EzLauncher.StatusName_2.Text = "API状态"
...
EzLauncher.StatusName_3.Text = "启动器状态"
...
EzLauncher.TextLabel_2.Text = "更新日志"
...
EzLauncher.TextLabel_3.Text = "启动信息"
...
if EzLauncher.EzHubStatusFrame.Status.Text == "离线" then
	EzLauncher.EzHubStatusFrame.Status.TextColor3 = Color3.fromRGB(192, 49, 52)
end
if EzLauncher.EzAPIStatusFrame.Status.Text == "离线" then
	EzLauncher.EzAPIStatusFrame.Status.TextColor3 = Color3.fromRGB(192, 49, 52)
end
if EzLauncher.EzLauncherStatusFrame.Status.Text == "离线" then
...
EzLauncher.Launch.MouseButton1Click:Connect(function()
	...
	--
	if not table.find(allowedOverrideUsers, game:GetService("Players").LocalPlayer.UserId) and (EzLauncher.EzHubStatusFrame.Status.Text == "离线" or
	EzLauncher.EzAPIStatusFrame.Status.Text == "离线" or
	EzLauncher.EzLauncherStatusFrame.Status.Text == "离线") then
		spawn(function()
			EzLauncher.Launch.Text = "服务器离线";
			wait(3);
			EzLauncher.Launch.Text = "Launch";
		end)
		return;
